...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rule' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-01-14 13:42:45',
                'modified' => '2019-01-14 13:42:45'
            ],
        ];
        parent::init();
    }
